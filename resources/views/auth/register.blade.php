...
@section('content')
    <div class="card-body login-card-body">
      <p class="login-box-msg">CRM Register</p>
      ...
      <form method="post" action="{{route('register')}}">
        ...
        <div class="row">
          <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block">Register <i class="fas fa-user-plus"></i></button>
          </div>
        </div>
      </form>
      ...
      <p align="center" class="mb-1">
        Already have an account just?   <a href="{{ route('login') }}" class="text-center">Log In</a>
      </p>
      <!--<p class="mb-0">
